...
export default function SystemHealthPage() {
  ...
  return (
    <>
      <PageHeader
        title="System Health"
        description="Current status of each platform service, including Mission 4's scan scheduler."
      />
      ...
      <SectionPanel
        ...
        description="Long-term analytical history of every candidate the Bot Runner has evaluated (Mission 7)"
      >
        <DecisionIntelligenceStatusPanel />
      </SectionPanel>
