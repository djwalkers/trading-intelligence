...
// Build 1.13.0 — routed through the shared server config layer instead of `Number(process.env...)`,
// which silently produced NaN (an effectively-zero setTimeout delay) for a malformed value instead
// of failing loudly at startup.
const POLL_INTERVAL_MS = getServerConfig().workerPollIntervalMs;
